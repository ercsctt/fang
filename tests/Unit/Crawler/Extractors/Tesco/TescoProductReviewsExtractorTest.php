...
beforeEach(function () {
    $this->extractor = new TescoProductReviewsExtractor;
});
...
describe('canHandle', function () {
    ...
    test('returns true for Tesco product URLs with additional path', function () {
        expect($this->extractor->canHandle('https://www.tesco.com/groceries/en-GB/products/987654321/reviews'))
            ->toBeTrue();
    });
...
describe('external ID generation', function () {
    ...
    test('generates deterministic ID when not provided', function () {
        ...
        expect($results[0]->externalId)->toStartWith('tesco-review-')
