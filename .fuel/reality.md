...
- **Console**: `php artisan crawler:run` - crawl one or more retailers (or `--all`)
- **Console**: `php artisan crawler:reviews` - dispatch review crawl jobs
- **Console**: `php artisan crawl:quality-report` - data quality summary per retailer
- **Console**: `php artisan queue:monitor` - queue health and throughput stats
...
- Added scheduled crawls and review crawling workflows
- Expanded retailer crawler coverage (major UK supermarkets + pet specialists)
- Added product matching, crawl statistics, and health monitoring reactors
- Added queue monitoring and data quality reporting commands
