...
class UpdateRetailerRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['required', 'string', 'max:255', Rule::unique('retailers', 'name')->ignore($retailerId)],
            'slug' => ['nullable', 'string', 'max:255', 'regex:/^[a-z0-9-]+$/', Rule::unique('retailers', 'slug')->ignore($retailerId)],
